...
/*
    <form class="space-y-6" action="#">
        <h5 class="text-xl font-medium text-gray-900 dark:text-gray-500">Sign in to our platform</h5>
        <div>
